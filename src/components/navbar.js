              ...
              <div className="px-5 pb-6 pt-5">
                <div className="flex items-center justify-between">
                  <div className="inline-flex items-center space-x-2">
                    ...
                    <span className="font-bold bg-white">MENU</span>
                  </div>
                  <div className="-mr-2">
                    <button
                      type="button"
                ...
                {/* <button
                  type="button"
                  className="mt-4 w-full rounded-md  px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                >
                  But
                </button> */}
              </div>
